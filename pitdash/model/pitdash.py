...
class PitData:
    def __init__(self, season, team_number, event_code, district_code='FIM') -> None:
        ...
        self.frc_model = FrcAPI(season, district_code, team_number,event_code)
    ...
    def get_team_stats(self):
        ...
        team_ccwms, team_oprs, team_dprs = self.tba_model.get_event_team_oprs(self.event_code, self.team_number)
        return  {
